...
function OrdersToProcess() {
    ...
    const getOrdersList = () => {
        axios.get(`/api/partners/getPartnerOrdersByID/${localStorage.getItem("PartnerID")}`).then(res => {
            ...
            if (res.data.status === 200) {
                setOrders(res.data.partnerOrders);
                console.log(res.data.partnerOrders)
            }
        })
    }
        ...
        axios.get('/sanctum/csrf-cookie').then(response => {
            axios.post('api/deliveryjob/updateDeliveryStatus', orderDataToDB).then(res => {
                ...
                if (res.data.status === 200) {
                    ...
                    var message = "Hello Dear " + orderData['customername'] + ". Your Order Has Process By Service Provider."
    ...
    const data = {
        columns: [
            ...
            },
            {
                ...
                field: 'orderid',
                render: order =>
                    <button className='btn btn-dark text-light' data-toggle="modal" data-target="#partnerProcessOrder" style={{ fontSize: 14 }} value={order.orderid} onClick={handleApproveButtonOnClick}>
                        <i class="fa fa-refresh" aria-hidden="true" style={{ marginRight: 8 }}></i>Process Order</button>
            },
        ],
        ...
        rows: ordersList.map(ordersdata => {
            return {
                ...
                estimatedelivery: ordersdata.estimatetime
            }
        }),
    };
    ...
    return (
        <>
            ...
            <div class="modal fade" id="partnerProcessOrder" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered modal-md" role="document">
                    <div class="modal-content">
                                    ...
                                    <div className="row">
                                        <div className="col-lg-12">
                                            <div className="row gx-8">
                                                ...
                                                <div className="col-lg-12 mb-3 mt-1 accountUpdate">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" class="btn btn-dark" data-dismiss="modal" value={orderData['orderid']} onClick={onOrderDeliver}>Process Order</button>
                        </div>
                    </div>
                </div>
            </div>
