                                    ...
                                    <div className="card-body p-4">
                                        <div className="d-flex text-black">
                                            <div className="flex-shrink-0">
                                                {customer.profilepic == null ? <img src={"http://www.vvc.cl/wp-content/uploads/2016/09/ef3-placeholder-image.jpg"} alt="Generic placeholder image" className="img-fluid" style={{ width: '180px', height: '180px', objectFit: 'cover', borderRadius: '10px' }} /> :
